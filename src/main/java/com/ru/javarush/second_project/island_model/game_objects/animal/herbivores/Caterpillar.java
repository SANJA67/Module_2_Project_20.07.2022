...
public class Caterpillar extends Herbiovores {

    public Caterpillar(String icon, BigDecimal weight, int speedCell, BigDecimal maximumSatiety, int[] whoToEatAndHowToEat, int id) {
